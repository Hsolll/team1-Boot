							...
							<a href="#" class="list-group-item list-group-item-action active">
								<div class="notification-info">
									<div class="notification-list-user-img">
										<img src="/resources/images/avatar-2.jpg" alt=""
								...
								<div class="notification-info">
									<div class="notification-list-user-img">
										<img src="/resources/images/avatar-3.jpg" alt=""
											class="user-avatar-md rounded-circle">
									</div>
									<div class="notification-list-user-block">
								...
								<div class="notification-info">
									<div class="notification-list-user-img">
										<img src="/resources/images/avatar-4.jpg" alt=""
											class="user-avatar-md rounded-circle">
									</div>
									<div class="notification-list-user-block">
								...
								<div class="notification-info">
									<div class="notification-list-user-img">
										<img src="/resources/images/avatar-5.jpg" alt=""
											class="user-avatar-md rounded-circle">
									</div>
									<div class="notification-list-user-block">
		...
		<li class="nav-item dropdown nav-user"><a
			...
			<div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
				...
				<div class="nav-user-info">
					<h5 class="mb-0 text-white nav-user-name">관리자</h5>
