			...
			<div id="boardSearch" class="text-right">
				<form id="f_search" name="f_search" class="form-inline">
					...
					<div class="form-group ml-auto">
						...
						<button type="button" class="btn btn-dark m-l-100">삭제</button>
					</div>
				</form>
			</div>
		<%--================== 검색기능 종료 ===================  --%>
				...
				<table summary="공지사항 리스트" class="table table-striped m-t-15" >
					<thead>
						<tr>
							...
							<th data-value="u_no" class="order text-center col-md-2" >신고글 번호</th>
							<th class="text-center col-md-2">아이디</th>
							<th class="text-center col-md-2">제목</th>
							<th data-value="b_date" class="text-center col-md-4">등록일</th>
							<th class="text-hide col-md-2">버튼영역</th>
						</tr>
					</thead>
