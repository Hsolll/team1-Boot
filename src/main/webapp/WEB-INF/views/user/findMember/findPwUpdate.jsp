            ...
            <div class="find_main">
                ...
                <section id="sectionBsns" style="display: block;">
                    <ul class="seller_guide">
                        <li>가입 시 입력한 <em>이메일</em>로 인증번호가 전송되었습니다.</li>
                        <li>인증번호 확인 후 비밀번호를 재설정 해주세요.</li>
                    ...
                    <fieldset class="form_box">
                        ...
                        <ul class="join_write">
                            ...
                            <li>
                                <label for="etprsMemIdntyNo" class="lable_hide">인증번호</label><input type="text" name="u_emailCheck" id="u_emailCheck" class="inp" placeholder="인증번호" maxlength="25" /> <span id="emailCodeCheck"></span><br />
                            </li>
                            <li>
                            ...
                            <li>
                                <label for="etprsMemIdntyNo" class="lable_hide">비밀번호 확인</label><input type="password" name="u_rpwd" id="u_rpwd" class="inp" placeholder="비밀번호확인" maxlength="25" /><span id="pwdCheck"></span>
                            </li>
