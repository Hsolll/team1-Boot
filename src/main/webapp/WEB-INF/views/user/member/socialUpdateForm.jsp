			...
			<input type="hidden" name="u_id" value="${update.u_id }" />
                   ...
                   <section id="sectionBsns">
                    ...
                    <ul class="tab" role="tablist" style="display: inline-flex;">
                        ...
                        <li id="tabBsns" role="presentation"><a id="tab2" role="tab" onclick="toggleTab('tabBsns');" aria-controls="tabBsns" data-log-actionid-area="tab" data-log-actionid-label="tab" aria-selected="true">주소관리</a></li>
                    </ul>  
                        <fieldset class="form_box" style="margin: 0px auto 0;">
                            <legend>소셜회원수정 폼</legend>
