...
<%@ include file="/WEB-INF/views/common/common.jspf" %>
		...
		<script type="text/javascript">
			$(function(){
				$(".content_wrap .page-header h1").html("글 수정");
				...
				$("#insertBtn").click(function(){
					...
					if(!chkData("#c_title", "제목을")) return;
						...
						$("#updateForm").attr({
							...
							"action":"/community/updateCommunity"
						});
						$("#updateForm").submit();
					}
				});
		...
		<div class="community_wite">
	        <form name="updateForm" id="updateForm">
	            ...
	            <table>
	                ...
	                <tbody>
	                    ...
	                    <tr>
	                        <th>제목</th>
	                        <td>
	                            <input type="text" class="w700" name="c_title" id="c_title" value="${ detail.c_title }" />
	                        </td>
	                    </tr>
	                    <tr>
	                        <th>내용</th>
	                        <td>
	                            <textarea name="c_content" id="c_content">${ detail.c_content }</textarea>
	                        </td>
	                    </tr>
	                    <tr>
	                        <th>이미지파일</th>
	            ...
	            <div class="buttonArea">
	                <button type="button" class="buttonBlack" id="insertBtn">저장하기</button>
