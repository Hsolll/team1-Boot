		...
		<script>
			$(function(){
				$("#chkBtn").click(function(){
					if(!chkData("#as_pwd", "비밀번호를")) return;
					else {
						$.ajax({
							url : "/admin/servicepwdChk",
							type : "post",
				...
				<div class="form-container">
					<div class="pwdContainer">
						<form name="pwdForm" id="pwdForm">
							<input type="hidden" name="as_no" value=${data.as_no }>
							PASSWORD   <input type="password" id="as_pwd" name="as_pwd" maxlength="20">
						</form>
