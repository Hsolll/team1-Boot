               ...
               <tbody id="list" class="table-striped">
                  <c:choose>
                     <c:when test="${not empty serviceMyPageList }">
                        <c:forEach var="serviceMyPage" items="${serviceMyPageList}" varStatus="status">
                           <tr class="text-center" data-no='${serviceMyPage.sc_no }'>
                              <td>${serviceMyPage.sc_no }</td>
                              <td class="goDetail text-left">${serviceMyPage.sc_title }</td>
                              <td class="text-center">${serviceMyPage.u_name }</td>
                              <td class="text-center">${serviceMyPage.sc_created_at }</td>
                              <td class="text-center">${serviceMyPage.sc_readcnt }</td>
                           </tr>
                           <c:choose>
                              <c:when test="${not empty admServiceList}">
                                 <c:forEach var="admservice" items="${admServiceList}" varStatus="status">
                                    ...
                                    <c:set var="sc" value="${serviceMyPage.sc_no}" />
