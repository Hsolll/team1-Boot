...
*/		$.ajax({
	...
	<!-- 		중고마켓 페이지로 돌아가기 -->
		...
		<form id="insertConfirm">
			<table>
				<tr>
					<%-- <th>상품번호 : ${update.p_no}</th> --%>
					
					<td><input type="hidden" name="p_no" placeholder="상품번호를 입력해주세요" value="${update.p_no }"/></td>
				</tr>
				<tr>
	<!-- 				<th>유저번호</th> -->
					<td><input type="hidden" name="u_no" placeholder="유저번호" value="${update.u_no}"/></td>
				</tr>
				<tr>
					<th>게시글제목</th>
					<td><input type="text" id="title" name="p_title"placeholder="상품제목을 입력해주세요" value="${update.p_title}"/></td>
				</tr>
				<tr>
					<th>상품이름</th>
					<td><input type="text" id="name" name="p_name" placeholder="상품이름 입력해주세요" value="${update.p_name}"/></td>
				</tr>
				<tr>
					<th>상품가격</th>
					<td>
						<input type="text" id="price-input" name="p_price" placeholder="상품 가격을 입력하세요" value="${update.p_price}"/>
						<input type="checkbox" id="free" name="p_free" value="1"> 무료나눔
	...
	<!-- 					</select> -->
				...
				<tr>
					<th>상품상세설명</th>
					<td><input type="text" id="content" name="p_content" placeholder="상품상세설명 입력해주세요" value="${update.p_content}"/></td>
				...
				<tr>
					...
					<td>
						...
						<input  type="hidden" id="p_local" name="p_local" readonly value="${update.p_local}"/>
					</td>
				</tr>
	...
	<!-- 					</select> -->
				...
				<tr>
					<td><input type="button" id="confirm" value="수정하기"/></td>
				</tr>
